...
var makeElement = function( rects , css , dim ){
	...
	var html = [
		'<div class="tag-cloud" style="',
			'position:relative;',
			'width:'+round( ( bb.right - bb.left ) * r )+'px;',
			'height:'+round( ( bb.bottom - bb.top ) * r )+'px;',
		'">'
	].join('');
	...
	for( var i=rects.length;i--;){
		...
		var rect = [
			'<span data-weight="'+ round( rects[i].size*r )+'" style="',
				'left:' + round((rects[i].x - bb.left)*r)+'px;',
				'top:' + round((rects[i].y - bb.top)*r)+'px;',
				'position:' + 'absolute;',
				'font-size:' + round(rects[i].size*r)+'px;',
				'white-space:' + 'nowrap;',
